...
// Lower temperatureStrength for milder warmth
const float temperature = 3300.0;       // was 2600.0 → slightly cooler
const float temperatureStrength = 1.0;  // was 1.0 → reduce intensity
